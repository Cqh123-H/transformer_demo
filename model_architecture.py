...
class MultiHeadedAttention(nn.Module):
    def __init__(self, h, d_model, dropout=0.1):
        ...
        assert d_model % h == 0
        # assert表达式为真时，程序继续往下执行，只是判断，不做任何处理；表达式为假时，抛出AssertionError错误，并将参数输出
        # we assumed d_v always equals d_k
        self.d_k = d_model // h
        self.h = h
    ...
    def forward(self, query, key, value, mask=None):
        ...
        # 1) Do all the linear projection in batch from d_model => h x d_k(批量投影)
